%% s181019_LDopaIcoh2 : take old freq, variation
...
zielfolder='/Users/guettlec/Desktop/SNR/iCOH/';
%dropboxfolder='/';
ordner=dir('*.mat');
files={ordner.name}';
clearvars ordner
...
for file_i=1:length(files)
    ...
    channelcombinations=freq.labelcmb;
      try
        ...
        xlim([80 120])
        xlabel('Frequency [Hz]')
        ylabel('iCOH ± jackknife SEM')
        title([dateiname(1:end-15) '_SNR_icoh_average'])


         saveas(fig_allcomb,[zielfolder dateiname(1:end-15) '_SNR_icoh_allcomb.png']);
         saveas(fig_average,[zielfolder dateiname(1:end-15) '_SNR_icoh_average.png']);
