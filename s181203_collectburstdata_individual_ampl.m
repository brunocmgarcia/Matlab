%%s181203_collectburstdata_individual_ampl

clear all
close all 
clc

histogram_einstellungMax=5e+6; % AUC: 5e+6 / power=30000;

histogram_einstellung=histogram_einstellungMax/10:histogram_einstellungMax/10:histogram_einstellungMax; % 4 AUC
...
for file_i=1:length(baselineschluessel)
    ...
    %ausschnitt=[ausschnitt zeros(amlaengsten-length(ausschnitt),1)'];%padding
